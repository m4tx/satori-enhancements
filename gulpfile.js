...
gulp.task('sass', function () {
    return gulp
        .src(path.join(EXT_DIR, 'scss/**/*.scss'), {
...
gulp.task(
    'vendor:hjsstyles',
    gulp.series('clean:vendor:hjsstyles', () =>
        gulp
...
gulp.task(
    'vendor',
    gulp.series('clean:vendor', 'vendor:hjsstyles', () =>
        gulp
            .src(vendorFiles)
...
gulp.task(
    'dist',
    gulp.series('build', 'clean:dist', () =>
        gulp.src(distFiles, { base: EXT_DIR }).pipe(gulp.dest('dist')),
    ),
);
...
gulp.task(
    ...
    gulp.series(
        ...
        gulp.parallel(
            () =>
                gulp.watch(
                    path.join(EXT_DIR, 'scss/**/*.scss'),
                    gulp.series('sass'),
                ),
            () =>
                gulp.watch(
                    path.join(EXT_DIR, 'js/**/*.js'),
                    gulp.series('jshint'),
                ),
        ),
    ),
